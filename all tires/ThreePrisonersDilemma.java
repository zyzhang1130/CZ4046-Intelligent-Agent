public class ThreePrisonersDilemma {
	...
	class T4TPlayer_both_and_TolerantPlayer_discount2_nasty2 extends Player {
		//Picks a random opponent at each play, 
		//and uses the 'tit-for-tat' strategy against them 
		int selectAction(int n, int[] myHistory, int[] oppHistory1, int[] oppHistory2) {
			if (n<30)
	...
	class T4TPlayer_both_and_TolerantPlayer_discount2_nasty3 extends Player {
		//Picks a random opponent at each play, 
		//and uses the 'tit-for-tat' strategy against them 
		int selectAction(int n, int[] myHistory, int[] oppHistory1, int[] oppHistory2) {
			if (n<30)
	...
	class T4TPlayer_both_and_TolerantPlayer_discount2_ver3_nasty2 extends Player {
		//Picks a random opponent at each play, 
		//and uses the 'tit-for-tat' strategy against them 
		int selectAction(int n, int[] myHistory, int[] oppHistory1, int[] oppHistory2) {
			if (n<20)
	...
	class T4TPlayer_both_and_TolerantPlayer_discount2_ver3_nasty3 extends Player {
		//Picks a random opponent at each play, 
		//and uses the 'tit-for-tat' strategy against them 
		int selectAction(int n, int[] myHistory, int[] oppHistory1, int[] oppHistory2) {
			if (n<20)
	...
	class T4TPlayer_both_and_TolerantPlayer_discount2_ver4_nasty2 extends Player {
		//Picks a random opponent at each play, 
		//and uses the 'tit-for-tat' strategy against them 
		int selectAction(int n, int[] myHistory, int[] oppHistory1, int[] oppHistory2) {
			if (n<10)
	...
	class T4TPlayer_both_and_TolerantPlayer_discount2_ver4_nasty3 extends Player {
		//Picks a random opponent at each play, 
		//and uses the 'tit-for-tat' strategy against them 
		int selectAction(int n, int[] myHistory, int[] oppHistory1, int[] oppHistory2) {
			if (n<10)
	...
	class T4TPlayer_both_and_TrickyPlayer3_nasty_202 extends Player {
		//Picks a random opponent at each play, 
		//and uses the 'tit-for-tat' strategy against them 
		int selectAction(int n, int[] myHistory, int[] oppHistory1, int[] oppHistory2) {
			if (n<20)
	...
	class T4TPlayer_both_and_TrickyPlayer3_nasty_203 extends Player {
		//Picks a random opponent at each play, 
		//and uses the 'tit-for-tat' strategy against them 
		int selectAction(int n, int[] myHistory, int[] oppHistory1, int[] oppHistory2) {
			if (n<20)
	...
	class TrickyPlayer3_and_TolerantPlayer_individual_both_Bboth_nasty_20 extends Player {
		//Picks a random opponent at each play, 
		//and uses the 'tit-for-tat' strategy against them 
		int selectAction(int n, int[] myHistory, int[] oppHistory1, int[] oppHistory2) {
			if (n<20)
	...
	class T4TPlayer_both_and_TolerantPlayer3_Bboth_40_nasty2 extends Player {
		//Picks a random opponent at each play, 
		//and uses the 'tit-for-tat' strategy against them 
		int selectAction(int n, int[] myHistory, int[] oppHistory1, int[] oppHistory2) {
			if (n<40)
	...
	class T4TPlayer_both_and_TolerantPlayer3_Bboth_20_nasty extends Player {
		//Picks a random opponent at each play, 
		//and uses the 'tit-for-tat' strategy against them 
		int selectAction(int n, int[] myHistory, int[] oppHistory1, int[] oppHistory2) {
			if (n<20)
...
/*		case 34: return new T4_3in10TPlayer_accumulate();*/
	...
	/*	case 37: return new TrickyPlayer();*/
		...
		case 41: return new TolerantPlayer4_Bboth();
		/*case 45: return new TolerantPlayer_Bboth();*/
		/*case 46: return new TolerantPlayer_Beither();*/
		case 14: return new TolerantPlayer_individual_both_discount1_Bboth();
/*		case 48: return new TolerantPlayer_individual_both_discount1_Beither();*/
		...
		case 30: return new TolerantPlayer_individual_both_discount2_Bboth();
		case 22: return new TolerantPlayer_individual_either_discount2_Bboth();
		/*case 52: return new TolerantPlayer_individual_either_discount2_Beither();*/
		case 24: return new TolerantPlayer_individual_either_discount1_Bboth();
		/*case 54: return new TolerantPlayer_individual_either_discount1_Beither();*/
		case 42: return new TolerantPlayer_individual_both_Bboth();
	...
	/*	case 62: return new UpToU1_forgiving3_42();*/
		case 27: return new UpToU1_discount3();
...
/*		case 85: return new T4TPlayer_both_and_TolerantPlayer_individual_both_40();*/
		case 26: return new T4TPlayer_both_and_TolerantPlayer3_Bboth_20();
		/*case 14: return new T4TPlayer_both_and_TolerantPlayer3_Bboth_20_nasty();*/
		case 19: return new T4TPlayer_both_and_TolerantPlayer3_Bboth_30();
		case 20: return new T4TPlayer_both_and_TolerantPlayer3_Bboth_40();
		case 4: return new T4TPlayer_both_and_TolerantPlayer3_Bboth_50();
...
/*		case 96: return new T43TPlayer_and_TolerantPlayer_30();*/
		case 29: return new Alternating2();
		case 39: return new GosuTheMinion();
		case 32: return new Bummer();
		case 18: return new PM_Low();
		case 37: return new Naing_Htet_Player();
		case 5: return new Chen_Zhiwei_Player();
		case 6: return new Mundhra_Shreyas_Sudhir_Player();
		case 31: return new T4TPlayer_both_and_TolerantPlayer_discount2_nasty();
		case 15: return new T4TPlayer_both_and_TolerantPlayer_discount2_ver3_nasty();
		/*case 41: return new T4TPlayer_both_and_TolerantPlayer3_Bboth_40_nasty();*/
		case 12: return new T4TPlayer_both_and_TolerantPlayer3_Bboth_40_nasty2();
		case 40: return new T4TPlayer_both_and_TolerantPlayer_discount2_ver4_nasty();
		/*case 58: return new T4TPlayer_both_and_TolerantPlayer3_Bboth_30_nasty();*/
		/*case 23: return new T4TPlayer_both_and_TolerantPlayer3_Bboth_50_nasty();*/
		/*case 14: return new T4TPlayer_both_and_TolerantPlayer3_20_nasty();*/
		case 28: return new T4TPlayer_both_and_TolerantPlayer_discount2_ver2_nasty();
		/*case 48: return new T4TPlayer_both_nasty();*/
		case 34: return new tsKennethTeo_Player();
	/*	case 5: return new T44TPlayer_deter();*/
		/*case 59: return new T45TPlayer();*/
		/*case 22: return new TrickyPlayer2();*/
		case 23: return new TrickyPlayer3();
		/*case 24: return new TrickyPlayer4();*/
		case 25: return new T4TPlayer_both_and_TrickyPlayer3_nasty_20();
		/*case 15: return new T4TPlayer_both_and_TrickyPlayer3_nasty_30();*/
		/*case 62: return new T4TPlayer_both_and_TrickyPlayer3_nasty_40();*/
	/*	case 25: return new T4TPlayer_both_and_TrickyPlayer3_nasty_50();*/
		/*case 30: return new TrickyPlayer3_nasty();*/
		/*case 22: return new TrickyPlayer3_and_T4TPlayer_both_nasty_20();*/
		/*case 32: return new TrickyPlayer3_and_T4TPlayer_both_nasty_30();*/
		/*case 43: return new TrickyPlayer3_and_T4TPlayer_both_nasty_40();*/
		/*case 41: return new TrickyPlayer3_and_T4TPlayer_both_nasty_50();*/
		case 33: return new TrickyPlayer3_biased();
		/*case 24: return new TrickyPlayer4_biased();*/
	/*	case 72: return new T4TPlayer_both_and_TrickyPlayer3_nasty_20_biased();*/
		/*case 80: return new T4TPlayer_both_and_TrickyPlayer3_nasty_30_biased();*/
		/*case 82: return new T4TPlayer_both_and_TrickyPlayer3_nasty_40_biased();*/
	/*	case 81: return new T4TPlayer_both_and_TrickyPlayer3_nasty_50_biased();*/
		/*case 6: return new TrickyPlayer3_nasty_biased();*/
		/*case 33: return new TrickyPlayer3_and_T4TPlayer_both_nasty_20_biased();*/
		/*case 34: return new TrickyPlayer3_and_T4TPlayer_both_nasty_30_biased();*/
		/*case 21: return new TrickyPlayer3_and_T4TPlayer_both_nasty_40_biased();*/
		/*case 13: return new TrickyPlayer3_and_T4TPlayer_both_nasty_50_biased();*/
		/*case 31: return new TrickyPlayer3_biased2();*/
		case 11: return new TrickyPlayer4_biased2();
		/*case 21: return new T4TPlayer_both_and_TrickyPlayer3_nasty_20_biased2();*/
		/*case 18: return new T4TPlayer_both_and_TrickyPlayer3_nasty_30_biased2();*/
		/*case 23: return new T4TPlayer_both_and_TrickyPlayer3_nasty_40_biased2();*/
		/*case 6: return new T4TPlayer_both_and_TrickyPlayer3_nasty_50_biased2();*/
		/*case 12: return new TrickyPlayer3_nasty_biased2();*/
	/*	case 28: return new TrickyPlayer3_and_T4TPlayer_both_nasty_20_biased2();*/
		/*case 74: return new TrickyPlayer3_and_T4TPlayer_both_nasty_30_biased2();*/
	...
	/*	case 14: return new TrickyPlayer3_and_T4TPlayer_both_nasty_50_biased2();*/
		case 13: return new TrickyPlayer31();
		case 21: return new TrickyPlayer31_biased();
		case 43: return new T4TPlayer_both_and_TolerantPlayer_discount2_ver3_nasty2();
		case 44: return new T4TPlayer_both_and_TrickyPlayer3_nasty_202();
		case 45: return new T4TPlayer_both_and_TrickyPlayer3_nasty_202();
		case 46: return new T4TPlayer_both_and_TolerantPlayer_discount2_nasty2();
		case 47: return new T4TPlayer_both_and_TolerantPlayer_discount2_nasty3();
		case 48: return new T4TPlayer_both_and_TolerantPlayer_discount2_ver3_nasty3();
		case 49: return new T4TPlayer_both_and_TolerantPlayer_discount2_ver4_nasty2();
		case 50: return new T4TPlayer_both_and_TolerantPlayer_discount2_ver4_nasty3();
		/*case 42: return new TrickyPlayer3_and_TolerantPlayer_individual_both_Bboth_nasty_20();*/
/*		case 152: return new TrickyPlayer41();*/
		/*case 4: return new T4TPlayer_both_and_TrickyPlayer3_nasty_60_biased();*/
		/*case 27: return new T4TPlayer_both_and_TrickyPlayer3_nasty_60_biased2();*/
